...
def json2txt(jsondata_path, output_path):
	'''
	arg:
...
if __name__ == '__main__':
	# paths;
	data_path = "C:\\CAPSTONE\\capstone2020\\yick\\test-videos\\activity-recognition\\json-files\\boxing\\*.json"
	output_path = "C:\\CAPSTONE\\capstone2020\\yick\\test-videos\\activity-recognition\\testingoutput.txt"
	json2txt(data_path, output_path)